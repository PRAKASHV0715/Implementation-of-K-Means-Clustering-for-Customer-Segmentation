...
4. Assign each data point to the nearest centroid using Euclidean distance and update the centroids by calculating the mean of each cluster.
...
## Output:
![alt text](<Screenshot 2026-02-25 093317.png>) ![alt text](<Screenshot 2026-02-25 093333.png>) ![alt text](<Screenshot 2026-02-25 093351.png>)
